...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hector_costmap' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jeff/RTB/Catkin_ws/install/${idir}'.  Ask the maintainer 'Stefan Kohlbrecher <kohlbrecher@sim.tu-darmstadt.de>' to fix it.")
    endif()
